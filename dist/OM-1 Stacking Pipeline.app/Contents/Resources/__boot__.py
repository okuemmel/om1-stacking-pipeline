...
_recipes_pil_prescript(['Jpeg2KImagePlugin', 'McIdasImagePlugin', 'Hdf5StubImagePlugin', 'XbmImagePlugin', 'PixarImagePlugin', 'GbrImagePlugin', 'XpmImagePlugin', 'FtexImagePlugin', 'BlpImagePlugin', 'MicImagePlugin', 'PdfImagePlugin', 'FitsImagePlugin', 'JpegImagePlugin', 'ImtImagePlugin', 'SgiImagePlugin', 'CurImagePlugin', 'GifImagePlugin', 'MpoImagePlugin', 'SunImagePlugin', 'PngImagePlugin', 'IptcImagePlugin', 'BmpImagePlugin', 'IcnsImagePlugin', 'ImImagePlugin', 'PpmImagePlugin', 'WebPImagePlugin', 'PsdImagePlugin', 'QoiImagePlugin', 'EpsImagePlugin', 'XVThumbImagePlugin', 'WmfImagePlugin', 'PcxImagePlugin', 'FliImagePlugin', 'IcoImagePlugin', 'PcdImagePlugin', 'TiffImagePlugin', 'DcxImagePlugin', 'GribStubImagePlugin', 'MspImagePlugin', 'BufrStubImagePlugin', 'MpegImagePlugin', 'FpxImagePlugin', 'SpiderImagePlugin', 'PalmImagePlugin', 'TgaImagePlugin', 'DdsImagePlugin'])
...
DEFAULT_SCRIPT='macro_stacking_web.py'
SCRIPT_MAP={}
_run()
